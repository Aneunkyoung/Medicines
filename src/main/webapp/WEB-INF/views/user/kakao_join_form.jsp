<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<form id="joinForm" method="post" action="${pageContext.request.contextPath}/kakaoJoin"  enctype="multipart/form-data">
	<div class="wrapper">
				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3">
						...
						<div class="form-group">
							<input id="name" name="name" class="form-control input-lg" type="text" placeholder="이름" value="${kakaoname}">
							<div id = "nameErr"></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input id="email" name="email" class="form-control input-lg" type="email" placeholder="본인인증 이메일" value="${kakaoemail}" readonly="readonly">
							<input id="profile" name="profile" class="form-control input-lg" type="hidden" placeholder="프로필" value="${kakaoprofile}" readonly="readonly">
							<div id = "emailErr"></div>
						</div>
						<div class="form-group">
