<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<form id="questionForm" action="${pageContext.request.contextPath }/question_write" method="post" enctype="multipart/form-data">
	<div class="wrapper">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						...
						<div class="form-group">
							<input type="checkbox" id="secret_chk" name="status" value="0">  비밀글
						</div>
						<p><button id="questionBtn" type="submit" class="btn btn-border-d btn-round btn-block">Submit</button></p>
					</div>
				</div>
			</div>
		</section>
